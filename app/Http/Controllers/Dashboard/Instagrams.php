...
class Instagrams extends Controller
{
    ...
    {
        // GET Instagrams
        $Instagrams = Instagram::simplePaginate(15);
    ...
    public function store(Request $request)
    {
        ...
        Instagram::create([  
            ...
            return redirect()->route('Instagrams.index')
                        ...
                        ->with('success','Shop Store successfully.');
    }
   ...
   /**
    ...
    public function update(Request $request, $slug)
    {
        ...
        $Instagram->sku = $request->input('sku');
        $Instagram->price = $request->input('price');
    ...
    public function destroy($id)
    {
        ...
        $Instagram->delete();
        return back()->with('Delete','Shop deleted successfully');
    }
}
