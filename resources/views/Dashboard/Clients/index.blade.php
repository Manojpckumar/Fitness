        ...
        <div class="container-md-height">
          <div class="row">
            ...
            <div class="card card-transparent">
              <div class="card-body">
                <h3><i class="fas fa-newspaper"></i> {{ __('Blogs')}} <a href="{{ route('Clients.create') }}" class="btn btn-tag btn-success btn-tag-rounded">{{ __('Add Blog')}}</a></h3>
              </div>
            </div>
            <!-- END card -->
          </div>
  ...
  <div class=" container-fluid   container-fixed-lg bg-white">
    ...
    <div class="card card-transparent">
      <div class="card-header ">
        <div class="card-title">{{ __('Table Blogs')}}
        </div>
