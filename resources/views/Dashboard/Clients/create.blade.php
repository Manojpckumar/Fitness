    ...
    <div class=" container-fluid  container-fixed-lg">
      <div class="inner">
        ...
        <ol class="breadcrumb">  
          ...
          <li class="breadcrumb-item"><a href="{{ route('Clients.index') }}">{{ __('Blogs')}}</a></li>
          <li class="breadcrumb-item active">{{ __('Create Blogs')}}</li>
        </ol>
        <!-- END BREADCRUMB -->
        <div class="container-md-height">
          <div class="row">
            ...
            <div class="card card-transparent">
              <div class="card-body">
                <h3><i class="fas fa-newspaper"></i> {{ __('New Blogs')}}</h3>
              </div>
            </div>
            <!-- END card -->
          </div>
  ...
  <div class=" container-fluid container-fixed-lg">
        ...
        <div class="card card-default">
          ...
          <form action="{{ route('Clients.store') }}" method="POST"  role="form" enctype="multipart/form-data"> 
            ...
            <div class="form-group form-group-default required">
              <label for="Title_en">{{ __('Blog Title')}}</label>
              <input type="text" class="form-control @error('Title_en') is-invalid @enderror" required="" placeholder="ex: Blog" id="Title_en" name="Title_en">
              @error('Title_en')
                <div class="alert alert-danger">{{ $message }}</div>
              @enderror 
            </div>
            <div class="form-group form-group-default required">
              <label for="body_en">{{ __('Blog Content English')}}</label>
              <input type="text" class="form-control @error('body_en') is-invalid @enderror" required="" placeholder="ex:Content Blog English" id="body_en" name="body_en">
              @error('body_en')
                <div class="alert alert-danger">{{ $message }}</div>
              @enderror 
            </div>
            ...
            <div class="col-lg-6">
              <div class="sm-m-l-5 sm-m-r-5">
                ...
                <textarea class="form-control" name="body_fr" placeholder="ex: Content Blog France" rows="10"></textarea>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div id="collapseThree" class="collapse" role="tabcard" aria-labelledby="headingThree">
                      <div class="card-body">
                        <div class="tab-pane" id="Arabic">
                          <div class="form-group form-group-default">
                            <label>{{ __('Title Blog Arabic') }}</label>
                            <input type="text" class="form-control" name="Title_ar"  placeholder="ex: Title Blog Arabic"></div>
                            <div class="form-group">
                            <textarea class="form-control" name="body_ar" placeholder="ex: Content Blog Arabic" rows="10"></textarea>
                            </div>
                            <!-- START card -->
                          </div>
                        </div>
    ...
    <div class="col-lg-6">
      ...
      <div class="card card-default">
        <div class="card-header ">
          <div class="card-title">
            {{ __('Drag and drop Blog Image Here')}} 
          </div>
        </div>
