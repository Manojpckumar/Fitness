    ...
    <div class=" container-fluid  container-fixed-lg">
      <div class="inner">
        ...
        <ol class="breadcrumb">  
          ...
          <li class="breadcrumb-item"><a href="{{ route('Clients.index') }}">{{ __('Blog')}}</a></li>
        ...
        <div class="container-md-height">
          <div class="row">
            ...
            <div class="card card-transparent">
              <div class="card-body">
                <h3><i class="pg-ui"></i>{{ __('Edit')}} {{ $Client->Title_en }}</h3>
              </div>
            </div>
            <!-- END card -->
          </div>
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            ...
            <div class="form-group form-group-default required">
              ...
              <input type="text" class="form-control @error('Title_en') is-invalid @enderror" required="" placeholder="ex: Blog" id="Title_en" name="Title_en" value="{!! $Client->Title_en !!}">
              @error('Title_en')
            ...
            <div class=" required">
              <label for="body_en">{{ __('Blog Content English')}}</label>
               <textarea class="form-control" name="body_en" placeholder="ex: Content Blog" rows="10"> {!! $Client->body_en !!}</textarea> 
            </div>
            <div class="row">     
            <div class="col-lg-6">
