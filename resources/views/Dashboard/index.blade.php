...
<li class="nav-item">
<a href="{{ option('Link')  }}" class="p-r-10" ><i class="pg-desktop"></i></a>
</li> 
</ul>
</div>
</div>
...
<span class="label font-montserrat fs-10">{{ __('Fitness Courses')}} {{ option('SiteTitle')  }}</span>
<br>
<p class="text-white m-t-10">{{ __('You have')}} {{ count(Posts()) }} 
                             {{ __('Fitness Courses in your Database.')}} </p>
<p class="text-white hint-text"><a href="{{ route('Posts.index') }}" class="text-white">{{ __('Learn More at Fitness Courses')}}</a></p>
</div>
</div>
</div>
<!-- END WIDGET -->
...
<div class="pull-bottom bottom-left bottom-right padding-25">
<span class="label font-montserrat fs-10">{{ __('Settings')}} {{ option('SiteTitle')  }}</span>
...
<div class="card-body">
<div class="pull-bottom bottom-left bottom-right padding-25">
<span class="label font-montserrat fs-10">{{ __('Instagrams')}}</span>
<br>
<p class="text-white m-t-10">{{ __('You have')}} {{ count(Instagrams()) }} {{ __('Instagrams in your Database.')}} </p>
<p class="text-white hint-text"><a href="{{ route('Instagrams.index') }}" class="text-white">{{ __('Learn More at Instagrams')}}</a></p>
</div>
</div>
</div>
<!-- END WIDGET -->
