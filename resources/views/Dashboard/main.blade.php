...
<img src="{{ asset(option('logo')) }}" class="brand" data-src="{{ asset(option('logo')) }}">
...
<li>
<a href="javascript:;"><span class="title">{{ __('Programs')}}</span>
<span class="arrow"></span></a>
<span class="bg-complete icon-thumbnail"><i class="fa fa-dumbbell"></i></span>
<ul class="sub-menu">
<li>
<a href="{{ url('Dashboard/Posts') }}">{{ __('Programs')}}</a>
<span class="icon-thumbnail"><i class="fa fa-dumbbell"></i></span>
</li>
<li>
<a href="{{ url('Dashboard/Posts/create') }}">{{ __('Create Programs')}}</a>
<span class="icon-thumbnail"><i class="fa fa-dumbbell"></i></span>
</li>
</ul>
</li>
<li>
<a href="javascript:;"><span class="title">{{ __('Shops')}}</span>
<span class="arrow"></span></a>
<span class="bg-complete icon-thumbnail"><i class="fas fa-shopping-basket"></i></span>
<ul class="sub-menu">
<li>
<a href="{{ url('Dashboard/Instagrams') }}">{{ __('Shops')}}</a>
<span class="icon-thumbnail"><i class="fas fa-shopping-basket"></i></span>
</li>
<li>
<a href="{{ url('Dashboard/Instagrams/create') }}">{{ __('Create Shops')}}</a>
<span class="icon-thumbnail"><i class="fas fa-shopping-basket"></i></span>
</li>
</ul>
</li>
...
<li>
<a href="{{ url('Dashboard/Clients') }}"><span class="title">{{ __('Blogs')}}</span></a>
<span class="bg-complete icon-thumbnail"><i class="fas fa-newspaper"></i></span>
</li>
<li>
<a href="{{ url('Dashboard/Galleries') }}"><span class="title">{{ __('Coaches')}}</span></a>
<span class="bg-complete icon-thumbnail"><i class="fas fa-chalkboard-teacher"></i></span>
</li>
<li>
<a href="{{ url('Dashboard/Books') }}"><span class="title">{{ __('Orders')}}</span></a>
<span class="bg-complete icon-thumbnail"><i class="fa fa-credit-card"></i></span>
</li>
<li>
