          ...
          <div class="card-body">
            ...
            <form action="{{ route('Galleries.update',$Gallery->slug) }}" method="POST"  role="form" 
              ...
              <input type="text" class="form-control @error('Title_en') is-invalid @enderror" required="" 
                     placeholder="ex: Coaches Title" id="Title_en" name="Title_en" value="{!! $Gallery->Title_en !!}">
              @error('Title_en')
            ...
            <div class="form-group form-group-default required">
              ...
              <input type="text" class="form-control @error('body_en') is-invalid @enderror" required="" placeholder="ex:Content Coaches" id="body_en" name="body_en" value="{!! $Gallery->body_en !!}">
              @error('body_en')
                <div class="alert alert-danger">{{ $message }}</div>
              @enderror 
            </div>
            <div class="form-group form-group-default required">
              ...
              <input type="text" class="form-control @error('position') is-invalid @enderror" required="" placeholder="ex:Content Coaches" id="position" name="position" value="{!! $Gallery->position !!}">
              @error('position')
                <div class="alert alert-danger">{{ $message }}</div>
              @enderror 
            </div>
