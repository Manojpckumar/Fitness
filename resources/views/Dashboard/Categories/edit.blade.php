        ...
        <div class="container-md-height">
          <div class="row">
            ...
            <div class="card card-transparent">
              <div class="card-body">
                <h3><i class="pg-folder"></i>  {{ __('Edit')}}  {{ $Category->Title_en }}</h3>
              </div>
            </div>
            <!-- END card -->
          </div>
                    ...
                    <div class="card-header lang-title" role="tab" id="headingTwo">
                      <div class="card-title">
                        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" >
                          <button class="btn btn-primary btn-sm  btn-rounded m-r-10"> {{ __('Turkey language')}}</button>
                        </a>
                      </div>
                    </div>
                        ...
                        <div class="tab-content bg-white col-xl-12">
                          <div class="tab-pane active" id="Turkey">
                            <div class="form-group form-group-default">
                              <label>{{ __('Category Türkiye')}}</label>
                              <input value="{{ $Category->Title_tr }}" type="text" name="Title_tr" class="form-control" placeholder="ex:Category Türkiye"> 
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="card-body">
                        <div class="tab-pane" id="Arabic">
                          <div class="form-group form-group-default">
                            ...
                            <input type="text" value="{{ $Category->Title_ar }}" class="form-control" name="Title_ar"  placeholder="ex: Title Category Arabic"></div>
                            <!-- START card -->
                          </div>
                        </div>
                      </div>
