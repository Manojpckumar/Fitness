    ...
    <div class=" container-fluid  container-fixed-lg">
      <div class="inner">
        ...
        <ol class="breadcrumb">  
          ...
          <li class="breadcrumb-item active"> {{ __('Create Shops')}}</li>
        </ol>
        <!-- END BREADCRUMB -->
        <div class="container-md-height">
          <div class="row">
            ...
            <div class="card card-transparent">
              <div class="card-body">
                <h3><i class="fas fa-shopping-basket"></i> {{ __('Add Shops')}} </h3>
              </div>
            </div>
            <!-- END card -->
          </div>
    ...
    <div class="row">
      <div class="col-lg-6">
        ...
        <div class="card card-default">
          ...
          @endif
          <div class="card-body">
          <form action="{{ route('Instagrams.store') }}" method="POST"  role="form" enctype="multipart/form-data"> 
              @csrf
            <div class="form-group form-group-default required">
              <label for="Title_en">{{ __('Shop Title')}}</label>
              <input type="text" class="form-control @error('Title_en') is-invalid @enderror" 
                     required="" placeholder="ex: Shop" id="Title_en" name="Title_en">
              @error('Title_en')
                <div class="alert alert-danger">{{ $message }}</div>
              @enderror 
            </div>
            <div class="form-group form-group-default required">
              <label for="body_en">{{ __('Shop Content')}}</label>
              <input type="text" class="form-control @error('body_en') is-invalid @enderror" 
                     required="" placeholder="ex:Content Shop" id="body_en" name="body_en">
              @error('body_en')
                <div class="alert alert-danger">{{ $message }}</div>
              @enderror 
            </div>
            <div class="form-group form-group-default required">
              <label for="sku">{{ __('Shop sku')}}</label>
              <input type="text" class="form-control @error('sku') is-invalid @enderror" 
                     required="" placeholder="ex:sku Shop" id="sku" name="sku">
              @error('sku')
                     <div class="alert alert-danger">{{ $message }}</div>
              @enderror 
            </div>
            <div class="form-group form-group-default required">
              ...
              <input type="text" class="form-control @error('price') is-invalid @enderror" 
                     required="" placeholder="ex:price Shop" id="price" name="price">
              @error('price')
                     <div class="alert alert-danger">{{ $message }}</div>
              @enderror 
            </div>
