...
<div class="login-wrapper">
  ...
  <div class="bg-pic">
    ...
    <img src="{{ asset(option('coverSettings')) }}" data-src="{{ asset(option('coverSettings')) }}" data-src-retina="{{ asset(option('coverSettings')) }}" 
    class="lazy">
    <!-- END Background Pic-->
 ...
 <div class="login-container bg-white">
  <div class="p-l-50 m-l-20 p-r-50 m-r-20 p-t-50 m-t-30 sm-p-l-15 sm-p-r-15 sm-p-t-40">
    <img src="{{ asset(option('logo')) }}" alt="logo" data-src="{{ asset(option('logo')) }}" data-src-retina="{{ asset(option('logo')) }}">
