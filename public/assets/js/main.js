(() => {
    var e = {
            764: function (e) {
                (e.exports = (function () {
                    "use strict";
                    const e = Object.freeze({ cancel: "cancel", backdrop: "backdrop", close: "close", esc: "esc", timer: "timer" }),
                        t = "SweetAlert2:",
                        n = (e) => {
                            const t = [];
                        ...
                        G = () => {
                            const e = i(x().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort((e, t) =>
                                    (e = parseInt(e.getAttribute("tabindex"))) > (t = parseInt(t.getAttribute("tabindex"))) ? 1 : e < t ? -1 : 0
                                ),
                        ...
                        te = (e, t) => {
                            for (let n = 0; n < e.childNodes.length; n++) if (Y(e.childNodes[n], t)) return e.childNodes[n];
                        },
                        ne = (e, t, n) => {
                        ...
                        Pe = (e, t) => {
                            const n = j(),
                                ...
                                o = B(),
                                r = D();
                            t.showConfirmButton || t.showDenyButton || t.showCancelButton ? se(n) : ie(n),
                                X(n, t, "actions"),
                                Ae(i, "confirm", t),
                                Ae(o, "deny", t),
                                Ae(r, "cancel", t),
                                Oe(i, o, r, t),
                                t.reverseButtons && (n.insertBefore(r, s), n.insertBefore(o, s), n.insertBefore(i, s)),
                                W(s, t.loaderHtml),
                                X(s, t, "loader");
                        };
                    function Oe(e, t, n, s) {
                        ...
                        Q([e, t, n], w.styled),
                            s.confirmButtonColor && ((e.style.backgroundColor = s.confirmButtonColor), Q(e, w["default-outline"])),
                            s.denyButtonColor && ((t.style.backgroundColor = s.denyButtonColor), Q(t, w["default-outline"])),
                            s.cancelButtonColor && ((n.style.backgroundColor = s.cancelButtonColor), Q(n, w["default-outline"]));
                    }
                    function Ae(e, t, n) {
                        re(e, n["show".concat(s(t), "Button")], "inline-block"),
                            W(e, n["".concat(t, "ButtonText")]),
                            e.setAttribute("aria-label", n["".concat(t, "ButtonAriaLabel")]),
                            (e.className = w[t]),
                            X(e, n, "".concat(t, "Button")),
                            Q(e, n["".concat(t, "ButtonClass")]);
                    }
                    function Me(e, t) {
                    ...
                    var Ie = { awaitingPromise: new WeakMap(), promise: new WeakMap(), innerParams: new WeakMap(), domCache: new WeakMap() };
                    const De = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
                        ...
                        Fe = {};
                    (Fe.text = Fe.email = Fe.password = Fe.number = Fe.tel = Fe.url = (e, t) => (
                    ...
                    const Re = (e, t) => {
                        ...
                        Ue = (e, t) => {
                            ...
                            return n && t.icon === n.icon
                                ? (Ze(s, t), void Xe(s, t))
                                : t.icon || t.iconHtml
                                ? t.icon && -1 === Object.keys(y).indexOf(t.icon)
                                    ? (r('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(t.icon, '"')), ie(s))
                                    : (se(s), Ze(s, t), Xe(s, t), void Q(s, t.showClass.icon))
                                : ie(s);
                        },
                        Xe = (e, t) => {
                        ...
                        Ze = (e, t) => {
                            (e.textContent = ""),
                                t.iconHtml
                                    ...
                                    : W(e, Qe({ question: "?", warning: "!", info: "i" }[t.icon]));
                        },
                        Je = (e, t) => {
                            if (t.iconColor) {
                        ...
                        ot = (e, t) => {
                            const n = C(),
                                s = x();
                            t.toast ? (ne(n, "width", t.width), (s.style.width = "100%"), s.insertBefore(I(), E())) : ne(s, "width", t.width),
                        ...
                        rt = (e, t) => {
                            (e.className = "".concat(w.popup, " ").concat(ae(e) ? t.showClass.popup : "")),
                                t.toast ? (Q([document.documentElement, document.body], w["toast-shown"]), Q(e, w.toast)) : Q(e, w.modal),
                                X(e, t, "popup"),
                                "string" == typeof t.customClass && Q(e, t.customClass),
                                t.icon && Q(e, w["icon-".concat(t.icon)]);
                        },
                        at = (e, t) => {
                    ...
                    const At = (e) => {
                            for (let t = e.target; t && t !== document; t = t.parentNode)
                                for (const e in Pt) {
                                    ...
                                    if (n) return void Pt[e].fire({ template: n });
                                }
                        },
                        Mt = {
                            title: "",
                    ...
                    function Vt() {
                        ...
                        ie(t.loader),
                            q() ? e.icon && se(E()) : qt(t),
                            ee([t.popup, t.actions], w.loading),
                    ...
                    const Rt = () => {
                            null === R.previousBodyPadding &&
                                ...
                                ((R.previousBodyPadding = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right"))), (document.body.style.paddingRight = "".concat(R.previousBodyPadding + ke(), "px")));
                        },
                        Wt = () => {
                    ...
                    var nn = { swalPromiseResolve: new WeakMap(), swalPromiseReject: new WeakMap() };
                    function sn(e, t, n, s) {
                        q() ? mn(e, s) : (wt(n).then(() => mn(e, s)), vt.keydownTarget.removeEventListener("keydown", vt.keydownHandler, { capture: vt.keydownListenerCapture }), (vt.keydownHandlerAdded = !1)),
                    ...
                    const dn = (e) => {
                        ...
                        un = (e) => (void 0 === e ? { isConfirmed: !1, isDenied: !1, isDismissed: !0 } : Object.assign({ isConfirmed: !1, isDenied: !1, isDismissed: !1 }, e)),
                        pn = (e, t, n) => {
                            const s = C(),
                                i = Ee && de(t);
                        ...
                        hn = (e, t, n, s, i) => {
                            (vt.swalCloseEventFinishedCallback = sn.bind(null, e, n, s, i)),
                    ...
                    const An = ["swal-title", "swal-html", "swal-footer"],
                        ...
                        _n = (e) => {
                            ...
                            Fn(t, n, e),
                                ...
                                V() && (qn(t, e.scrollbarPadding, s), en()),
                                q() || vt.previousActiveElement || (vt.previousActiveElement = document.activeElement),
                                "function" == typeof e.didOpen && setTimeout(() => e.didOpen(n)),
                                ee(t, w["no-transition"]);
                        },
                        Gn = (e) => {
                            const t = x();
                        ...
                        Fn = (e, t, n) => {
                            Q(e, n.showClass.backdrop),
                                ...
                                Q([document.documentElement, document.body], w.shown),
                                n.heightAuto && n.backdrop && !n.toast && Q([document.documentElement, document.body], w["height-auto"]);
                        },
                        Rn = (e, t) => {
                        ...
                        Kn = (e, t) => {
                            ...
                            u(t.inputOptions) || h(t.inputOptions)
                                ...
                                ? s(t.inputOptions)
                                : r("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(typeof t.inputOptions));
                        },
                        Zn = (e, t) => {
                            const n = e.getInput();
                            ie(n),
                        ...
                        os = (e, t, n) => {
                            ...
                            e.disableInput(),
                                Promise.resolve()
                                    .then(() => p(s.inputValidator(t, s.validationMessage)))
                                    .then((s) => {
                        ...
                        rs = (e, t) => {
                            ...
                            n.showLoaderOnDeny && mt(B()),
                                n.preDeny
                                    ? (Ie.awaitingPromise.set(e || void 0, !0),
                                      Promise.resolve()
                                          .then(() => p(n.preDeny(t, n.validationMessage)))
                                          .then((n) => {
                                              !1 === n ? e.hideLoading() : e.closePopup({ isDenied: !0, value: void 0 === n ? t : n });
                                          })
                                          .catch((t) => ls(e || void 0, t)))
                    ...
                    const ks = (e, t) => {
                        ...
                        Ps = (t, n, s) =>
                            new Promise((i, o) => {
                                ...
                                nn.swalPromiseResolve.set(t, i),
                                    nn.swalPromiseReject.set(t, o),
                                    (n.confirmButton.onclick = () => ts(t)),
                                    (n.denyButton.onclick = () => ns(t)),
                                    (n.cancelButton.onclick = () => ss(t, r)),
                        ...
                        Os = (e) => {
                            const t = { popup: x(), container: C(), actions: j(), confirmButton: L(), denyButton: B(), cancelButton: D(), loader: I(), closeButton: H(), validationMessage: M(), progressSteps: A() };
                        ...
                        Ls = (e, t) =>
                            t.focusDeny && ae(e.denyButton) ? (e.denyButton.focus(), !0) : t.focusCancel && ae(e.cancelButton) ? (e.cancelButton.focus(), !0) : !(!t.focusConfirm || !ae(e.confirmButton) || (e.confirmButton.focus(), 0)),
                        Bs = () => {
                    ...
                    function $s(e) {
                        ...
                        at(this, i), Ie.innerParams.set(this, i), Object.defineProperties(this, { params: { value: Object.assign({}, this.params, e), writable: !1, enumerable: !0 } });
                    }
                    function Is() {
                        const e = Ie.domCache.get(this),
                            t = Ie.innerParams.get(this);
                        t
                            ? (e.popup && vt.swalCloseEventFinishedCallback && (vt.swalCloseEventFinishedCallback(), delete vt.swalCloseEventFinishedCallback),
                              vt.deferDisposalTimer && (clearTimeout(vt.deferDisposalTimer), delete vt.deferDisposalTimer),
        ...
        (() => {
            ...
            const h = {
                    ...
                    for (let e = 0; e < this.length; e += 1) {
                        ...
                        if (n)
                            for (l = 0; l < a.length; l += 1) {
                                const e = a[l];
                                t.dom7LiveListeners || (t.dom7LiveListeners = {}), t.dom7LiveListeners[e] || (t.dom7LiveListeners[e] = []), t.dom7LiveListeners[e].push({ listener: s, proxyListener: o }), t.addEventListener(e, o, i);
                            }
                        else
                            for (l = 0; l < a.length; l += 1) {
                                const e = a[l];
                                t.dom7Listeners || (t.dom7Listeners = {}), t.dom7Listeners[e] || (t.dom7Listeners[e] = []), t.dom7Listeners[e].push({ listener: s, proxyListener: r }), t.addEventListener(e, r, i);
                            }
                    }
                    return this;
                },
                        ...
                        for (let e = 0; e < this.length; e += 1) {
                            ...
                            if ((!n && o.dom7Listeners ? (r = o.dom7Listeners[t]) : n && o.dom7LiveListeners && (r = o.dom7LiveListeners[t]), r && r.length))
                                for (let e = r.length - 1; e >= 0; e -= 1) {
                                    const n = r[e];
                                    (s && n.listener === s) || (s && n.listener && n.listener.dom7proxy && n.listener.dom7proxy === s)
                                        ? (o.removeEventListener(t, n.proxyListener, i), r.splice(e, 1))
                                        : s || (o.removeEventListener(t, n.proxyListener, i), r.splice(e, 1));
                                }
                        }
                    }
                    return this;
                ...
                trigger: function (...e) {
                    ...
                    for (let i = 0; i < n.length; i += 1) {
                        ...
                        for (let n = 0; n < this.length; n += 1) {
                            const i = this[n];
                            if (t.CustomEvent) {
                                const n = new t.CustomEvent(o, { detail: s, bubbles: !0, cancelable: !0 });
                ...
                is: function (e) {
                    ...
                    if ("string" == typeof e) {
                        ...
                        for (o = d(e), l = 0; l < o.length; l += 1) if (o[l] === s) return !0;
                        return !1;
                    }
                    if (e === n) return s === n;
                    if (e === t) return s === t;
                ...
                prepend: function (e) {
                    ...
                    for (n = 0; n < this.length; n += 1)
                        ...
                        } else if (e instanceof a) for (s = 0; s < e.length; s += 1) this[n].insertBefore(e[s], this[n].childNodes[0]);
            ...
            function v(e, t = "x") {
                ...
                return (
                    n.WebKitCSSMatrix
                        ...
                        : ((o = a.MozTransform || a.OTransform || a.MsTransform || a.msTransform || a.transform || a.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,")), (s = o.toString().split(","))),
                    "x" === t && (i = n.WebKitCSSMatrix ? o.m41 : 16 === s.length ? parseFloat(s[12]) : parseFloat(s[4])),
                    "y" === t && (i = n.WebKitCSSMatrix ? o.m42 : 16 === s.length ? parseFloat(s[13]) : parseFloat(s[5])),
                    i || 0
                );
            }
            function b(e) {
                        ...
                        (S = (function ({ userAgent: e } = {}) {
                            ...
                            return (
                                !d &&
                                    ...
                                    ((d = i.match(/(Version)\/([\d.]+)/)), d || (d = [0, 1, "13_0_0"]), (m = !1)),
            ...
            const A = {
                ...
                updateSlides: function () {
                            ...
                            d[i] && (d[i].swiperSlideSize = E),
                                ...
                                s.centeredSlides
                                    ? ((C = C + E / 2 + T / 2 + w),
                                      ...
                                      h.push(C))
                                    : (s.roundLengths && (C = Math.floor(C)), (S - Math.min(e.params.slidesPerGroupSkip, S)) % e.params.slidesPerGroup == 0 && p.push(C), h.push(C), (C = C + E + w)),
                                (e.virtualSize += E + w),
                                (T = E),
                                (S += 1);
                        }
                    ...
                    if (
                        ...
                        r && a && ("slide" === s.effect || "coverflow" === s.effect) && i.css({ width: `${e.virtualSize + s.spaceBetween}px` }),
                    ...
                    if ((0 === p.length && (p = [0]), 0 !== s.spaceBetween)) {
                        ...
                        d.filter((e, t) => !s.cssMode || t !== d.length - 1).css({ [n]: `${w}px` });
                    }
                    ...
                    if ((Object.assign(e, { slides: d, snapGrid: p, slidesGrid: h, slidesSizesGrid: m }), s.centeredSlides && s.cssMode && !s.centeredSlidesBounds)) {
                ...
                updateSlidesProgress: function (e = (this && this.translate) || 0) {
                    ...
                    for (let e = 0; e < s.length; e += 1) {
                        ...
                        ((u >= 0 && u < t.size - 1) || (p > 1 && p <= t.size) || (u <= 0 && p >= t.size)) && (t.visibleSlides.push(a), t.visibleSlidesIndexes.push(e), s.eq(e).addClass(n.slideVisibleClass)),
                            (a.progress = i ? -c : c),
                ...
                updateProgress: function (e) {
                    ...
                    const a = o,
                        l = r;
                    0 === s ? ((i = 0), (o = !0), (r = !0)) : ((i = (e - t.minTranslate()) / s), (o = i <= 0), (r = i >= 1)),
                ...
                updateSlidesClasses: function () {
                    const e = this,
                        { slides: t, params: n, $wrapperEl: s, activeIndex: i, realIndex: o } = e,
                        r = e.virtual && n.virtual.enabled;
                    let a;
                    t.removeClass(`${n.slideActiveClass} ${n.slideNextClass} ${n.slidePrevClass} ${n.slideDuplicateActiveClass} ${n.slideDuplicateNextClass} ${n.slideDuplicatePrevClass}`),
                        (a = r ? e.$wrapperEl.find(`.${n.slideClass}[data-swiper-slide-index="${i}"]`) : t.eq(i)),
                        a.addClass(n.slideActiveClass),
                        n.loop &&
                            (a.hasClass(n.slideDuplicateClass)
                                ? s.children(`.${n.slideClass}:not(.${n.slideDuplicateClass})[data-swiper-slide-index="${o}"]`).addClass(n.slideDuplicateActiveClass)
                                : s.children(`.${n.slideClass}.${n.slideDuplicateClass}[data-swiper-slide-index="${o}"]`).addClass(n.slideDuplicateActiveClass));
                ...
                updateActiveIndex: function (e) {
                    const t = this,
                        ...
                        { slidesGrid: s, snapGrid: i, params: o, activeIndex: r, realIndex: a, snapIndex: l } = t;
                    let c,
                        d = e;
                    if (void 0 === d) {
                ...
                updateClickedSlide: function (e) {
                    ...
                    (t.clickedSlide = s),
                        t.virtual && t.params.virtual.enabled ? (t.clickedIndex = parseInt(m(s).attr("data-swiper-slide-index"), 10)) : (t.clickedIndex = i),
            ...
            const M = {
                ...
                setTranslate: function (e, t) {
                    const n = this,
                        { rtlTranslate: s, params: i, $wrapperEl: o, wrapperEl: r, progress: a } = n;
                    let l,
                        c = 0,
                        d = 0;
                    n.isHorizontal() ? (c = s ? -e : e) : (d = e),
                        i.roundLengths && ((c = Math.floor(c)), (d = Math.floor(d))),
                        i.cssMode ? (r[n.isHorizontal() ? "scrollLeft" : "scrollTop"] = n.isHorizontal() ? -c : -d) : i.virtualTranslate || o.transform(`translate3d(${c}px, ${d}px, 0px)`),
                ...
                translateTo: function (e = 0, t = this.params.speed, n = !0, s = !0, i) {
                    ...
                    if (((d = s && e > l ? l : s && e < c ? c : e), o.updateProgress(d), r.cssMode)) {
                        ...
                        if (0 === t) a[e ? "scrollLeft" : "scrollTop"] = -d;
                            ...
                            if (!o.support.smoothScroll) return C({ swiper: o, targetPosition: -d, side: e ? "left" : "top" }), !0;
            ...
            const B = {
                slideTo: function (e = 0, t = this.params.speed, n = !0, s, i) {
                    ...
                    let r = e;
                    r < 0 && (r = 0);
                    const { params: a, snapGrid: l, slidesGrid: c, previousIndex: d, activeIndex: u, rtlTranslate: p, wrapperEl: h, enabled: m } = o;
                    ...
                    let b;
                    if (((b = r > u ? "next" : r < u ? "prev" : "reset"), (p && -v === o.translate) || (!p && v === o.translate)))
                    ...
                    return (
                        0 === t
                            ? (o.setTransition(0), o.setTranslate(v), o.updateActiveIndex(r), o.updateSlidesClasses(), o.emit("beforeTransitionStart", t, s), o.transitionStart(n, b), o.transitionEnd(n, b))
                            : (o.setTransition(t),
                              o.setTranslate(v),
                ...
                slidePrev: function (e = this.params.speed, t = !0, n) {
                    const s = this,
                        { params: i, animating: o, snapGrid: r, slidesGrid: a, rtlTranslate: l, enabled: c } = s;
                    if (!c) return s;
                    if (i.loop) {
                    ...
                    return (
                        void 0 !== h &&
                            ...
                            "auto" === i.slidesPerView && 1 === i.slidesPerGroup && i.slidesPerGroupAuto && ((m = m - s.slidesPerViewDynamic("previous", !0) + 1), (m = Math.max(m, 0)))),
                        s.slideTo(m, e, t, n)
                    );
                },
                ...
                slideToClickedSlide: function () {
                    ...
                    if (t.loop) {
                        ...
                        (i = parseInt(m(e.clickedSlide).attr("data-swiper-slide-index"), 10)),
                            t.centeredSlides
                                ? o < e.loopedSlides - s / 2 || o > e.slides.length - e.loopedSlides + s / 2
                                    ? (e.loopFix(),
            ...
            const $ = {
                ...
                loopFix: function () {
                    ...
                    const { activeIndex: t, slides: n, loopedSlides: s, allowSlidePrev: i, allowSlideNext: o, snapGrid: r, rtlTranslate: a } = e;
                    let l;
            ...
            function D(e) {
                ...
                if (!n.allowTouchMove) return (n.allowClick = !1), void (s.isTouched && (Object.assign(r, { startX: u, startY: p, currentX: u, currentY: p }), (s.touchStartTime = g())));
                ...
                if (void 0 === s.isScrolling) {
                    ...
                    (n.isHorizontal() && r.currentY === r.startY) || (n.isVertical() && r.currentX === r.startX)
                        ? (s.isScrolling = !1)
                        : h * h + f * f >= 25 && ((e = (180 * Math.atan2(Math.abs(f), Math.abs(h))) / Math.PI), (s.isScrolling = n.isHorizontal() ? e > o.touchAngle : 90 - e > o.touchAngle));
                }
                ...
                if (
                    ...
                    v > 0 && s.currentTranslate > n.minTranslate()
                        ? ((b = !1), o.resistance && (s.currentTranslate = n.minTranslate() - 1 + (-n.minTranslate() + s.startTranslate + v) ** w))
                        : v < 0 && s.currentTranslate < n.maxTranslate() && ((b = !1), o.resistance && (s.currentTranslate = n.maxTranslate() + 1 - (n.maxTranslate() - s.startTranslate - v) ** w)),
                    ...
                    if (!s.allowThresholdMove)
                        return (s.allowThresholdMove = !0), (r.startX = r.currentX), (r.startY = r.currentY), (s.currentTranslate = s.startTranslate), void (r.diff = n.isHorizontal() ? r.currentX - r.startX : r.currentY - r.startY);
                }
                o.followFinger &&
                    !o.cssMode &&
                    (((o.freeMode && o.freeMode.enabled && n.freeMode) || o.watchSlidesProgress) && (n.updateActiveIndex(), n.updateSlidesClasses()),
            ...
            function j(e) {
                const t = this,
                    n = t.touchEventsData,
                    { params: s, touches: i, rtlTranslate: o, slidesGrid: r, enabled: a } = t;
                if (!a) return;
                let l = e;
                ...
                if (
                    (t.allowClick && (t.updateClickedSlide(l), t.emit("tap click", l), d < 300 && c - n.lastClickTime < 300 && t.emit("doubleTap doubleClick", l)),
                    (n.lastClickTime = g()),
                    f(() => {
            ...
            const V = (e, t) => {
                const n = i(),
                    ...
                    p = t;
                if (c.touch) {
                    const t = !("touchstart" !== o.start || !c.passiveListener || !s.passiveListeners) && { passive: !0, capture: !1 };
                    r[u](o.start, e.onTouchStart, t), r[u](o.move, e.onTouchMove, c.passiveListener ? { passive: !1, capture: d } : d), r[u](o.end, e.onTouchEnd, t), o.cancel && r[u](o.cancel, e.onTouchEnd, t);
                ...
                (s.preventClicks || s.preventClicksPropagation) && r[u]("click", e.onClick, !0),
                    ...
                    s.updateOnWindowResize ? e[p](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", z, !0) : e[p]("observerUpdate", z, !0);
            };
            const q = {
            ...
            const R = {
                setBreakpoint: function () {
                    const e = this,
                        { activeIndex: t, initialized: n, loopedSlides: s = 0, params: i, $el: o } = e,
                        r = i.breakpoints;
            ...
            const W = {
                addClasses: function () {
                    const e = this,
                        { classNames: t, params: n, rtl: s, $el: i, device: o, support: r } = e,
                        a = (function (e, t) {
                            const n = [];
                            return (
                                e.forEach((e) => {
                ...
                return function (n = {}) {
                    ...
                    "object" == typeof i && null !== i
                        ? (["navigation", "pagination", "scrollbar"].indexOf(s) >= 0 && !0 === e[s] && (e[s] = { auto: !0 }),
                          s in e && "enabled" in i ? (!0 === e[s] && (e[s] = { enabled: !0 }), "object" != typeof e[s] || "enabled" in e[s] || (e[s].enabled = !0), e[s] || (e[s] = { enabled: !1 }), w(t, n)) : w(t, n))
                        : w(t, n);
                };
            }
            const X = {
                    ...
                    transition: {
                        ...
                        transitionStart: function (e = !0, t) {
                            const n = this,
                                { params: s } = n;
                            s.cssMode || (s.autoHeight && n.updateAutoHeight(), L({ swiper: n, runCallbacks: e, direction: t, step: "Start" }));
                        },
                        transitionEnd: function (e = !0, t) {
                            const n = this,
                                { params: s } = n;
                            (n.animating = !1), s.cssMode || (n.setTransition(0), L({ swiper: n, runCallbacks: e, direction: t, step: "End" }));
                        },
                    },
                    slide: B,
                    loop: $,
            ...
            class Z {
                constructor(...e) {
                    let t, n;
                    if (
                        (1 === e.length && e[0].constructor && "Object" === Object.prototype.toString.call(e[0]).slice(8, -1) ? (n = e[0]) : ([t, n] = e), n || (n = {}), (n = w({}, n)), t && !n.el && (n.el = t), n.el && m(n.el).length > 1)
                    ) {
                        const e = [];
                        return (
                            m(n.el).each((t) => {
                    ...
                    const i = {};
                    s.modules.forEach((e) => {
                        e({ swiper: s, extendParams: U(n, i), on: s.on.bind(s), once: s.once.bind(s), off: s.off.bind(s), emit: s.emit.bind(s) });
                    });
                    const o = w({}, Y, i);
                    return (
                        (s.params = w({}, o, K, n)),
                ...
                slidesPerViewDynamic(e = "current", t = !1) {
                    const { params: n, slides: s, slidesGrid: i, slidesSizesGrid: o, size: r, activeIndex: a } = this;
                    let l = 1;
                    if (n.centeredSlides) {
                        let e,
                ...
                update() {
                    ...
                    n.breakpoints && e.setBreakpoint(),
                        ...
                        e.params.freeMode && e.params.freeMode.enabled
                            ...
                            : ((i = ("auto" === e.params.slidesPerView || e.params.slidesPerView > 1) && e.isEnd && !e.params.centeredSlides ? e.slideTo(e.slides.length - 1, 0, !1, !0) : e.slideTo(e.activeIndex, 0, !1, !0)), i || s()),
                            ...
                            e.params.resizeObserver && void 0 !== s.ResizeObserver
                                ? e &&
                                  ...
                                  ((i = new ResizeObserver((t) => {
                                      ...
                                      let i = n,
                                          r = s;
                                      t.forEach(({ contentBoxSize: t, contentRect: n, target: s }) => {
            ...
            J.use([
                function ({ swiper: e, extendParams: t, on: n, emit: s }) {
                    ...
                    function o(t, n) {
                        ...
                        t &&
                            t.length > 0 &&
                            (t[n ? "addClass" : "removeClass"](s.disabledClass), t[0] && "BUTTON" === t[0].tagName && (t[0].disabled = n), e.params.watchOverflow && e.enabled && t[e.isLocked ? "addClass" : "removeClass"](s.lockClass));
                    }
                    function r() {
                    ...
                    function c() {
                        ...
                        n && n.length > 0 && n.on("click", l),
                            ...
                            Object.assign(e.navigation, { $nextEl: n, nextEl: n && n[0], $prevEl: s, prevEl: s && s[0] }),
                ...
                function ({ swiper: e, extendParams: t, on: n, emit: s }) {
                    ...
                    function c() {
                        ...
                        if (
                            ...
                            if (
                                (n.dynamicBullets &&
                                    ...
                                    n.dynamicMainBullets > 1 && void 0 !== e.previousIndex && ((r += d - e.previousIndex), r > n.dynamicMainBullets - 1 ? (r = n.dynamicMainBullets - 1) : r < 0 && (r = 0)),
                                    (i = d - r),
                        ...
                        "custom" === n.type && n.renderCustom ? (c.html(n.renderCustom(e, d + 1, u)), s("paginationRender", c[0])) : s("paginationUpdate", c[0]),
                        ...
                        t.attr("data-swiper-autoplay") && (n = t.attr("data-swiper-autoplay") || e.params.autoplay.delay),
                            ...
                            (o = f(() => {
                                ...
                                e.params.autoplay.reverseDirection
                                    ? e.params.loop
                                        ? (e.loopFix(), (t = e.slidePrev(e.params.speed, !0, !0)), s("autoplay"))
                                        : e.isBeginning
                                        ? e.params.autoplay.stopOnLastSlide
                                            ? l()
                                            : ((t = e.slideTo(e.slides.length - 1, e.params.speed, !0, !0)), s("autoplay"))
                                        : ((t = e.slidePrev(e.params.speed, !0, !0)), s("autoplay"))
                                    : e.params.loop
                                    ? (e.loopFix(), (t = e.slideNext(e.params.speed, !0, !0)), s("autoplay"))
                                    : e.isEnd
                                    ? e.params.autoplay.stopOnLastSlide
                                        ? l()
            ...
            document.addEventListener("DOMContentLoaded", function () {
                window.addEventListener("scroll", de),
                    (function (e, t, n) {
                        ...
                        navigation: { nextEl: ".hero_slider-control--next", prevEl: ".hero_slider-control--prev" },
                        autoplay: { delay: 5e3 },
                    });
            });
        })();
